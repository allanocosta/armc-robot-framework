...
Search list for all Activities
    ...
    [Tags]    servicetest    fakerestapi    activities    get_all_activities
...
Search For An Activity By Specific Id
    ...
    [Tags]    servicetest    fakerestapi    activities    get_an_activity
...
Add A New Activity
    ...
    [Tags]    servicetest    fakerestapi    activities    post_new_activity
...
Edit An Existing Activity
    ...
    [Tags]    servicetest    fakerestapi    activities    put_edit_activity
...
Delete An Existing Activity
    ...
    [Tags]    servicetest    fakerestapi    activities    delete_activity
