...
${TextCartEmpty}    Seu carrinho de compras da Amazon está vazio.
...
Remove A Product From Cart
    [Arguments]     ${Product}
    Click    xpath=//span[contains(@class,'a-size-medium')]//span[contains(@class,'a-truncate-cut') and .='${Product}']/../../../../../../..//input[@value='Excluir']
